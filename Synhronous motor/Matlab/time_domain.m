...
plot(time_array,(VphaA-VphaB)+0.4*(Vfsw_A-Vfsw_B+VfswSL_A-VfswSL_B+VfswSH_A-VfswSH_B), ...
    'DisplayName','Inverter Current','color','k','LineWidth',1)
hold on;
% yline(0,'LineWidth',0.5)
minus=-2;
plot(time_array,(VphaA-VphaB)+minus,'color','r','DisplayName','Motor Current','LineWidth',1)
hold on;
% yline(minus,'LineWidth',0.5)
minus=-4;
plot(time_array,0.4*(Vfsw_A-Vfsw_B+VfswSL_A-VfswSL_B+VfswSH_A-VfswSH_B)+minus, ...
    'DisplayName','WPT Current','color','b','LineWidth',1);
% yline(minus,'LineWidth',0.5)
ylim([-5 1.5])
set(gca,'xtick',[0 0.02 0.04 0.06 0.08])
% xticklabels({'0' 'Ts'  '2Ts' '3Ts' '4Ts'})
set(gca,'xticklabels', {'0' 'Ts'  '2Ts' '3Ts' '4Ts'},'FontName','Times New Roman', 'FontSize', 16)
% grid on;
% grid minor;
set(gca,'ytick',[])
...
set(legend1,...
    'Location','Best','box','off','FontName','Times New Roman', 'FontSize', 14);
