...
view([45 45])
% view([0 0])
zlabel('$  |\frac{V_{l-n}}{V_{DC}} |$','interpreter','Latex','FontSize',24,'FontName','Times New Roman');
xlabel({'Frequency'},'interpreter','Latex','FontSize',20,'Rotation',-28, ...
    'Position',[13.976226263883973,-0.185740739206413,-0.271919374452214],'FontName','Times New Roman');
ylabel({'Modulation Index'},'Rotation',25,'interpreter','Latex','FontSize',20, ...
    'Position',[21.4056,0.2169,-0.2498],'FontName','Times New Roman')
%%
f=[0 2 5 7 9 13 15 17 19 ];
color=['g','m','r','k','b','r','g','m','b'];
figure();
