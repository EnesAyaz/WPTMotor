...
% i = "" "03" "06" "086"
i=86;
folder="G:\My Drive\WPT-MOTOR\Test-Result\2022.09.29\C2ma0";
filename2=strcat(folder,int2str(i));
filename=strcat(filename2,"_makale_10khz00000.dat");
filename=strcat(filename2,"_makale00000.dat");
