...
plot(ma,carrier_phase1,'LineWidth',2,'Color',[1 0 0]);
...
ylabel('Carrier Phase Shift (^o)','FontName','Times New Roman','FontSize',25);
xlabel('Modulation Index','FontName','Times New Roman','FontSize',25);
