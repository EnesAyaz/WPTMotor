...
f=[0 2 5 7 9 13 15 17 19 ];
color=['g','m','r','k','b','r','g','m','b'];
color=[ 0 0.5 0; 0.5 0 0.5 ; 0.5 0 0 ; 0 0 0 ; 0 0 0.5; 0.5 0 0; 0 0.5 0; 0.5 0 0.5 ; 0 0 0.5  ];
figure();
...
% A=sqrt(A)/sqrt(2);
A=sqrt(A);
stem3(X,Y,A,'Marker','^','MarkerSize',10,'LineWidth',2,'Color',color(i,:))
else 
A=MagX_A(:,i).*0;
stem3(X,Y,A,'Marker','^','MarkerSize',10,'LineWidth',2,'Color',color(i,:))  
end
...
view([45 45])
% view([0 0])
% zlabel('$  |\frac{V_{l-l}}{V_{DC}} |$','interpreter','Latex','FontSize',24,'FontName','Times New Roman');
zlabel({'The Normalized','Magnitude of Harmonics'},'FontSize',18,...
    'FontName','Times New Roman',...
    'Interpreter','latex');
% Create ylabel
ylabel({'Modulation Index '},'FontSize',18,'FontName','Times New Roman',...
    'Rotation',28,...
    'Interpreter','latex');
% Create xlabel
xlabel({'Frequency'},'FontSize',18,'FontName','Times New Roman',...
    'Rotation',-25,...
    'Interpreter','latex');
%%
...
% grid off;
xticks(f)
xticklabels({'DC','f_R','f_L','f_C','f_H','2f_s-3f_o','2f_s-f_o','2f_s+f_o','2f_s+3f_o'})
...
% view([0 0])
% zlabel('$  |\frac{V_{l-l}}{V_{DC}} |$','interpreter','Latex','FontSize',24,'FontName','Times New Roman');
% zlabel({'The Normalized',' Magnitude ($\hat{U}$)'},'FontSize',25,...
%     'FontName','Times New Roman',...
%     'Interpreter','latex');
% Create ylabel
% ylabel({'Modulation Index '},'FontSize',25,'FontName','Times New Roman',...
%     'Rotation',27,...
%     'Interpreter','latex');
% Create xlabel
% xlabel({'Frequency'},'FontSize',25,'FontName','Times New Roman',...
%     'Rotation',-27,...
%     'Interpreter','latex');
