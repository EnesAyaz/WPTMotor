...
plot(time_VAB_m06_phi0,data_VAB_m06_phi0,'Color',[1 0 0],'LineWidth',0.1);
...
figure1.Position = [0 0 600 200];
axes1 = axes('Parent',figure1);
plot(time_VAB_m06_phi475,data_VAB_m06_phi475,'Color',[0 0 1],'LineWidth',0.1);
