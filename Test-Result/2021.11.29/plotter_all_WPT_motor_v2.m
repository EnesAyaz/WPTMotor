...
plot(time_onlymotor,data_onlymotor,'Color',[1 0 0],'LineWidth',2);
...
figure1.Position = [0 0 300 200];
axes1 = axes('Parent',figure1);
plot(time_onlymotor,data_onlyWPT,'Color',[0 0 1],'LineWidth',2);
set(axes1,'FontName','Times New Roman','FontSize',12);
% -5.10e-5
grid on;
xlim([-0.1065,-0.0065])
...
axes1 = axes('Parent',figure1);
plot(time_motor,data_motor,'Color',[1 0 0],'LineWidth',2);
hold on;
plot(time_WPT,data_WPT,'Color',[0 0 1],'LineWidth',2);
set(axes1,'FontName','Times New Roman','FontSize',12);
grid on;
xlim([-0.1050,-0.0050])
ylim([-4 4])
...
% Create textarrow
annotation(figure1,'textarrow',[0.716 0.678000000000001],[0.785 0.71],...
    'String','$I_{TX}$',...
    'Interpreter','latex',...
    'FontSize',12,...
...
% Create textarrow
annotation(figure1,'textarrow',[0.324 0.292],[0.79 0.73],'String','$I_M$',...
    'Interpreter','latex',...
    'FontSize',12,...
    'FontName','Times New Roman');
